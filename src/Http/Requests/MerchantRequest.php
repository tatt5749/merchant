...
namespace Merchant\Merchant\Http\Requests;
...
class MerchantRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('merchant');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access merchant module,
    ...
    {
        return user()->canDo('merchant.merchant.view');
    }
}
