...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Merchant\Merchant\Http\Controllers';
    ...
    public function boot()
    {
        ...
        if (Request::is('*/merchant/merchant/*')) {
            Route::bind('merchant', function ($merchant) {
                $merchantrepo = $this->app->make('Merchant\Merchant\Interfaces\MerchantRepositoryInterface');
                return $merchantrepo->findorNew($merchant);
            });
        }
